...
nav_frame = tk.Frame(root, bg="#576CBC")
nav_frame.place(relx=0,rely=0,relwidth=1,relheight=0.08)

# Create a label for the title on the left corner
title_label = tk.Label(nav_frame, text="Farm Eazy", bg="#576CBC", fg="white", padx=10,font='Helvetica 18 bold')
title_label.pack(side="left")

# Create a frame for the buttons on the right
button_frame = tk.Frame(nav_frame, bg="#576CBC")
button_frame.pack(side="right")

# Create three buttons
button1 = tk.Button(button_frame, text="Home", bg="#576CBC", fg="white", padx=10, borderwidth=0, highlightthickness=0,font='Helvetica 14 bold')
button1.pack(side="right", padx=10)

button2 = tk.Button(button_frame, text="Log Out", bg="#576CBC", fg="white", padx=10, borderwidth=0, highlightthickness=0,font='Helvetica 14 bold')
button2.pack(side="right", padx=10)

button3 = tk.Button(button_frame, text="About us", bg="#576CBC", fg="white", padx=10, borderwidth=0, highlightthickness=0,font='Helvetica 14 bold')
button3.pack(side="right", padx=10)

# Create the login form
frame = tk.LabelFrame(root, bg="#576CBC")
frame.place(relx=0.3, rely=0.55, relwidth=0.4, relheight=0.75, anchor="center")
frame.configure(borderwidth=3)
...
area_label = tk.Label(frame, text="Area:", bg="#576CBC" ,font='Helvetica 18 bold',fg="white")
...
crop_label = tk.Label(frame, text="crop:", bg="#576CBC",font='Helvetica 18 bold',fg="white")
